"""API for gentex_place bound to Home Assistant OAuth."""
...
class ConfigEntryAuth(my_pypi_package.AbstractAuth):
    """Provide gentex_place authentication tied to an OAuth2 based config entry."""
    ...
    def __init__(
        ...
        """Initialize gentex_place Auth."""
        self.hass = hass
        self.session = oauth_session
        super().__init__(self.session.token)

    def refresh_tokens(self) -> str:
        """Refresh and return new gentex_place tokens using Home Assistant OAuth2 session."""
